...
#спрашиваем товар
    state: chooseItem
        a: Какой товар вас интересует или действующее вещество? Может быть клемастин, тавигил, ацетилсалициловая кислота или аспирин?
        buttons:
            "аспирин"
            "тавигил"
...
#реакция на нераспознанное
    state: CatchAll  || noContext=true
        ...
        random: 
             ...
             a: Вы хотите поставить уведомления о приеме лекарств или оформить подписку на автоматическую ежемесячную доставку?  
        script: 
             $reactions.buttons({ text: "Выбрать товар", transition: "/chooseItem" }); 
             $reactions.buttons({ text: "Подобрать аналог", transition: "../analogue" }); 
             $reactions.buttons({ text: "Поставить напоминание", transition: "../Reminder" });
